...
\begin{homeworkProblem}
  ...
  \problemAnswer{
    ...
    \begin{align*}
      ...
      &=X^3-3X^2\mu-X\mu^2+\mu^3\\
      &=X^3-3X^2\mu
    \end{align*}
    The last two terms cancel because $E[X]=\mu$.
    Recall, that earlier, we discovered $E[X^2]=e^2$. Plugging in
    what we know,
    \begin{equation*}
      \gamma_1=\frac{E[X^3]-3e^2\sqrt{e}}{(e^2-e)^{3/2}}
    \end{equation*}
    To determine $E[X^3]$,
    \begin{align*}
      E[X^3]&=\int_{0}^\infty
    ...
    Plugging this in,
    \begin{equation*}
      \gamma_1=\frac{e^{9/2}-3e^{5/2}}{(e^2-e)^{3/2}}
    \end{equation*}
  }
\end{homeworkProblem}
