...
\begin{homeworkProblem}
  ...
  to our problem it breaks down. I do Monte sampling to
  check whether our answer is correct, for some reason
  the beta variable makes things difficult, so I am changing it
  to 2. With this one modification on the problem...everything works
  and converges and agrees...kind of annoying.
  ...
  \begin{table}[H]
    \begin{center}
      ...
      \begin{tabular}{l l l c}
        ...
        \hline
        1   & 0.0022 & 2.32e-5 & Yes\\
        1.5 & 0.00034 & 1.78e-6 & Yes\\
        3   & 5.3e-06 & 5.77e-09 & Yes\\
        5   & 1.13e-07 & 1.91e-11 & Yes\\
        \bottomrule
      \end{tabular}
    \end{center}
  \end{table}
...
\begin{homeworkProblem}
  ...
  \begin{table}[H]
    \begin{center}
      ...
      \begin{tabular}{l l l l}
        ...
        \hline
        1   & 0.201131 & 0.118690392736 & 0.0189858423462\\
        1.5 & 110135 & 0.0695356185309 & 0.0116978422222\\
        3   & 0.0228748 & 0.0234676697455 & 0.00367690231561\\
        5   & 0.0032849 & 0.00938868980513 & 0.00117123205791\\
        \bottomrule
      \end{tabular}
    \end{center}
  \end{table}
  ...
  \problemAnswer{
    It should be noted that the calculated answers above
    were done with a gamma distribution of G(1.2,1.2) to
    have a reasonable difference between the values.
