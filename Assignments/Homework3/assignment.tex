...
\begin{homeworkProblem}
  ...
  \begin{equation*}
    ...
    2\pi\ \phi\left(\frac{x\cdot z}{\beta}\right)
  ...
  Also, I am grouping $2\pi$ with the flux for all the calculations,
  not the fastest, but I am not trying to break any records
  (except the one of taking the longest to do homeworks).\\
  ...
  \begin{align*}
    ...
    &\approx\sum_{i=1}^{n'}\frac{\Gamma(n'+\alpha)z_i}
        {n'!(n'+\alpha)(L_{n'-1}^{\alpha}(z_i))^2}
        2\pi\ \phi\left(\frac{x\cdot z_i}{\beta}\right)\\
  \end{align*}
  ...
  \pythonscript{Problem5/Test}{Code for Comparison}
  ...
  \pythonscript{Problem5/Calculations}{Code for Problem}
