...
\begin{homeworkProblem}
  ...
  \problemAnswer{
    ...
    \begin{equation*}
      E=\sum_{i=1}^{4}
      \frac{\text{New Calculation}-\text{Original or Measured}}
      {\text{Original or Measured}}\cdot\text{Propagated Error}
    \end{equation*}
    ...
    The error was included in this data so that measurements or
    calculations that have lower errors pull the distribution
    more. I am assuming both errors are of the same type.\\
  }
