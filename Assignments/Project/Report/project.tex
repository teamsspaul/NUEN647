...
%\item[\done]{Determine how to vary half-life information for calculation}
  ...
  %\inputdeckpages{../Origen2/TAPE9_BANK}{\tss{137}Cs decay libary
  %  3 input}{2896}{2897}
  ...
  \pythonscript{../ChangeTAPE/smaller_change}{Script for modifying ORIGEN2 input.}
...
\item[\done]{Create a sampling space for all possible variations of
  ...
  \pythonscript{../ChangeTAPE/Sample_Gen}{Sample Generation code}
  ...
  \begin{figure}[H]
    \begin{center}
      \includegraphics[width=0.77\columnwidth]{../ChangeTAPE/94Pu239aHIST.pdf}
      \vspace{-5mm}
  ...
  \begin{figure}[H]
    \begin{center}
      \includegraphics[width=0.77\columnwidth]{../ChangeTAPE/94Pu240fHIST.pdf}
      \vspace{-5mm}
