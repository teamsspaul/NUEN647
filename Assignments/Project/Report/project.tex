...
one group cross sections, but this is due to
improperly sampling the cross sections.
There is no variation
in the output, even when a cross section is changed by a
factor of over 1000, ORIGEN is not taking up
